...
def build_visual_review_checklist() -> list[dict[str, object]]:
    return [
        ...
        },
        {
            ...
            "figure_id": "figure3",
            "export_category": "manuscript",
            "check": "Panel C duration sensitivity labeled non-rescuing; ZLPI/MWPI/SWPI visually distinct",
            "status": "pending_review",
        },
        {
            ...
            "figure_id": "figure3",
            "export_category": "manuscript",
            "check": "Broadband residualization is retained as supplementary/sensitivity export, not manuscript Panel D",
            "status": "pending_review",
        },
        {
            ...
            "figure_id": "figure3",
            "export_category": "manuscript",
            "check": "Panel D shows locked cardiac-field controls with explicit not_computable statuses; no endpoint substitution",
            "status": "pending_review",
        },
        {
            ...
            "figure_id": "figure3",
            "export_category": "manuscript",
            "check": "Manuscript export includes figure3_temporal_artifact_specificity (A–D) plus standalone figure3_panel_e_nuisance_modality",
            "status": "pending_review",
        },
        {
