...
Configs live under ``zero-lag-reanalysis-repo/`` (``master.yaml``, ``datasets/``,
``smoke/``). Exploratory Stages 0–4 remain in ``ppg_eeg.temporal_coupling`` with
configs in ``exploratory-temporal-coupling/``.
"""
